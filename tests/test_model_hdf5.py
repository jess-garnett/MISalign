from MISalign.model.hdf5 import MISProjectHDF5, MISImageHDF5,load_mis_project_hdf5
...
class TestMISProjectHDF5():
    ...
    def test_load_str(self):
        test_filepath="tests/test_files/model_hdf5/mytestfile1.hdf5"
...
class Test_setup_image():
    def test_setup_imagefile(self):
        assert type(setup_image(
            ...
            hdf5_filepath="tests/test_files/model_hdf5/mytestfile1.hdf5",
            image_type="hdf5",
            PIL_mode="RGB"
        ))==MISImageHDF5
...
class TestMISImageHDF5():
    ...
    def test_image_save_change(self):
        test_image_data=dict(
            ...
            PIL_mode="RGB")
        test_image=MISImageHDF5(**test_image_data)
        change_test_img_a01="tests/test_files/model_hdf5/mytestfile2.hdf5"
        test_image.hdf5_filepath=Path(change_test_img_a01)
        assert test_image.save_dict()==dict(
            image_name="a_myimages01.jpg",
            hdf5_filepath="tests/test_files/model_hdf5/mytestfile2.hdf5",
            image_type="hdf5",
            PIL_mode="RGB")
